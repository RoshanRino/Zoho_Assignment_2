...
public:
    ...
    void possibleMovement(int i,int j)
    {
        ...
        {
            if(board[i][j+1]->getType() =="black" ) cout<<place(i,j+1)<<" Take Piece "<<board[i][j+1]->getType()<<endl;
        ...
        {
            if(board[i-1][j]->getType() == "black") cout<<place(i-1,j)<<" Take Piece "<<board[i-1][j]->getType()<<endl;
        ...
        {
            if(board[i+1][j+1]->getType()=="black") cout<<place(i+1,j+1)<<" Take Piece "<<board[i+1][j+1]->getType()<<endl;
